    ...
    do{
		...
		case 3:
			...
			}else
			{
				...
				printf("Se actualizó la nueva lista con los rating cargados aleatoriamente.\n\n");
				flagAsignarRating = 1;
			}
			break;
		...
		case 4:
			...
			}else
			{
				...
				controller_ListMovie(listaPeliculasNueva);
				printf("Se actualizó la nueva lista con géneros cargados aleatoriamente.\n\n");
				flagAsignarGenero = 1;
			}
			break;
		...
		case 5:
			...
			{
				printf("\nPrimero asigne Rating y Géneros.\n\n");
			}
		...
		case 6:
			if(flagAsignarRating == 1 && flagAsignarGenero == 1)
			{
				...
				controller_ListMovie(listaPeliculasNueva);
				printf("La lista ahora esta ordenada por Género y Rating (Descendente)\n\n");
				flagOrdenamiento = 1;
			}else
			{
				printf("\nPrimero asigne Rating y Géneros.\n\n");
