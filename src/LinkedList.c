...
///
/// @param this recibe la LinkedList
/// @param pFunc puntero a la funcion filtrante
/// @return retorna un LinkedList nuevo con los elementos que pasan el filtrado
/// o NULL en el caso de error en parametros
...
/// @brief Crea una nueva lista igual a la que recibe, pero con nuevos
/// valores los cuales asigna mediante una funcion.
///
/// @param this recibe la LinkedList
/// @param pFunc puntero a la funcion que asigna valores
/// @return retorna un LinkedList nuevo con los elementos que asigna
/// la funcion pFunc, o NULL en el caso de error en parametros
